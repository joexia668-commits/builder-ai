...
export type ImportExportMismatch = {
  importerPath: string;
  exporterPath: string;
  missingNamed: string[];   // named imports with no matching named export
  missingDefault: boolean;  // default import with no default export
};
