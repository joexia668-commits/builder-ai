...
JSON schema（intent/features/persistence/modules 为必填，dataModel/complexity/gameType 可选）：
{"intent":"string","features":["string"],"persistence":"none|localStorage|supabase","modules":["string"],"dataModel":["string"],"complexity":"simple|complex","gameType":"platformer|puzzle|shooter|card|simple2d"}
...
- complexity：项目复杂度，modules > 3 或 features > 5 时填 "complex"，否则填 "simple"
- gameType：如果是游戏项目填写游戏类型: platformer | puzzle | shooter | card | simple2d，否则省略此字段
