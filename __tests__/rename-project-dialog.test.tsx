...
describe("RenameProjectDialog", () => {
  ...
  it("RPD-01a: renders dialog title '重命名项目'", () => {
    render(<RenameProjectDialog projectName="My Test App" onConfirm={onConfirm} onCancel={onCancel} />);
  ...
  it("RPD-07: shows '保存中...' and disables confirm when isLoading=true", () => {
    render(<RenameProjectDialog projectName="My Test App" onConfirm={onConfirm} onCancel={onCancel} isLoading={true} />);
    fireEvent.change(screen.getByRole("textbox"), { target: { value: "New Name" } });
